...
function initialize_map_canvas() {
    ...
    var sg_marker = createMarker(sg_latlng, '<h2>Sather Gate</h2><p class="info-address">Sather Rd, Berkeley, CA 94720</p></br><p class="info-story">4 Stories</p><p class="info-tour">2 Tours</p><a href="location_stories.html" class="info-view-more">View More</a>');
